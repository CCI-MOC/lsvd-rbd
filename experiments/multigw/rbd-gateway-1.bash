...
rbd -p $pool_name rm $imgname.multigw.3 || true
rbd -p $pool_name rm $imgname.multigw.4 || true
rbd -p $pool_name create --size $imgsize --thick-provision $imgname.multigw.1
rbd -p $pool_name create --size $imgsize --thick-provision $imgname.multigw.2
rbd -p $pool_name create --size $imgsize --thick-provision $imgname.multigw.3
rbd -p $pool_name create --size $imgsize --thick-provision $imgname.multigw.4
wait
