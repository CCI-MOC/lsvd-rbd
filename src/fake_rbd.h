 ...
 */
enum { EVENT_TYPE_PIPE = 1, EVENT_TYPE_EVENTFD = 2 };
...
extern "C" CEPH_RBD_API int
rbd_poll_io_events(rbd_image_t image, rbd_completion_t *comps, int numcomp);

extern "C" CEPH_RBD_API int rbd_set_image_notification(rbd_image_t image,
                                                       int fd, int type);

extern "C" CEPH_RBD_API int
rbd_aio_create_completion(void *cb_arg, rbd_callback_t complete_cb,
                          rbd_completion_t *c);
...
extern "C" CEPH_RBD_API int rbd_aio_flush(rbd_image_t image,
                                          rbd_completion_t c);
...
extern "C" CEPH_RBD_API int rbd_aio_writev(rbd_image_t image,
...
extern "C" CEPH_RBD_API int rbd_read(rbd_image_t image, uint64_t off,
                                     size_t len, char *buf);

extern "C" CEPH_RBD_API int rbd_write(rbd_image_t image, uint64_t off,
                                      size_t len, const char *buf);
...
extern "C" CEPH_RBD_API int rbd_snap_create(rbd_image_t image,
                                            const char *snapname);
extern "C" CEPH_RBD_API int
rbd_snap_list(rbd_image_t image, rbd_snap_info_t *snaps, int *max_snaps);
extern "C" CEPH_RBD_API void rbd_snap_list_end(rbd_snap_info_t *snaps);
extern "C" CEPH_RBD_API int rbd_snap_remove(rbd_image_t image,
                                            const char *snapname);
extern "C" CEPH_RBD_API int rbd_snap_rollback(rbd_image_t image,
                                              const char *snapname);

extern "C" CEPH_RBD_API int
rbd_diff_iterate2(rbd_image_t image, const char *fromsnapname, uint64_t ofs,
                  uint64_t len, uint8_t include_parent, uint8_t whole_object,
...
extern "C" CEPH_RBD_API int
rbd_encryption_format(rbd_image_t image, rbd_encryption_format_t format,
...
extern "C" CEPH_RBD_API int rbd_encryption_load(rbd_image_t image,
                                                ...
                                                size_t opts_size);
extern "C" CEPH_RBD_API int rbd_get_features(rbd_image_t image,
                                             uint64_t *features);
...
extern "C" CEPH_RBD_API void
rbd_linked_image_spec_cleanup(rbd_linked_image_spec_t *image);
extern "C" CEPH_RBD_API int
rbd_mirror_image_enable(rbd_image_t image) CEPH_RBD_DEPRECATED;
...
extern "C" CEPH_RBD_API int
rbd_mirror_image_enable2(rbd_image_t image, rbd_mirror_image_mode_t mode);
typedef enum {
...
extern "C" CEPH_RBD_API int
rbd_mirror_peer_site_add(rados_ioctx_t io_ctx, char *uuid,
                         size_t uuid_max_length,
                         rbd_mirror_peer_direction_t direction,
                         const char *site_name, const char *client_name);
...
extern "C" CEPH_RBD_API int rbd_mirror_peer_site_remove(rados_ioctx_t io_ctx,
                                                        const char *uuid);
extern "C" CEPH_RBD_API int
rbd_mirror_peer_site_set_attributes(rados_ioctx_t p, const char *uuid,
                                    const char *keys, const char *values,
                                    size_t key_value_count);
extern "C" CEPH_RBD_API int
rbd_mirror_peer_site_set_name(rados_ioctx_t io_ctx, const char *uuid,
                              const char *site_name);
extern "C" CEPH_RBD_API int
rbd_mirror_peer_site_set_client_name(rados_ioctx_t io_ctx, const char *uuid,
...
extern "C" CEPH_RBD_API int
rbd_pool_stats_option_add_uint64(rbd_pool_stats_t stats, int stat_option,
                                 uint64_t *stat_val);
typedef enum {
...
extern "C" CEPH_RBD_API void
rbd_trash_get_cleanup(rbd_trash_image_info_t *info);
