...
hdr_pp = [['magic', magic], ['type', fieldnames], ['write_super', '%d'], ['read_super', '%d']]

wsup_pp = [['magic', magic], ['type', fieldnames], ['seq', '%d'], ['base', '%d'], ['limit', '%d'],
               ['next', '%d'], ['oldest', '%d']]

rsup_pp = [["magic", magic], ["type", fieldnames], ["unit_size", '%d'], ["base", '%d'], ["units", '%d']]
