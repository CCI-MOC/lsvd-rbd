...
SOFLAGS = -shared -fPIC
OBJS = base_functions.o misc_cache.o translate.o io.o read_cache.o nvme.o request.o send_request.o write_cache.o file_backend.o rados_backend.o refactor_lsvd.o
CFILES = base_functions.cc misc_cache.cc translate.cc io.cc read_cache.cc nvme.cc request.cc send_request.cc write_cache.cc file_backend.cc rados_backend.cc refactor_lsvd.cc
