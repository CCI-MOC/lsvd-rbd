...
void add_crc(sector_t sector, const char *_buf, size_t bytes, int seq,
             bool verbose)
{
...
unsigned show_crc(sector_t sector) { return sector_crc[sector]; }
unsigned show_seq(sector_t sector) { return sector_seq[sector]; }
